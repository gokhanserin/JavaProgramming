...
public class UnaryOperators {
    ...
    public static void main(String[] args) {
        ...
        int b = 100;
        System.out.println(++b);  // pre increment: it increases the value 1 immediately.

        System.out.println("----------------------------------");

        int c = 100;
        System.out.println(c++);  // post incerement: first passes the current value, then increase the value by 1
