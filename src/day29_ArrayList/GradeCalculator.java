...
public class GradeCalculator {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Integer>gradesOfA = new ArrayList<>(scores); // 90--100
        gradesOfA.removeIf(p-> !(p>=90 && p<=100));
        ...
        ArrayList<Integer>gradeOfF = new ArrayList<>(scores); // <60
        gradeOfF.removeAll(gradesOfA);
        ...
        System.out.println("Total number of A: " + gradesOfA.size());
