...
*/
        ...
        list2.addAll(Arrays.asList(1,2,3,4,5,6,7,8,9));  // remove even numbers
        ...
        list3.addAll(Arrays.asList("Java", "Python", "JavaScript", "c#", "C++", "Java", "Ruby")); // remove elements starts with "J"
