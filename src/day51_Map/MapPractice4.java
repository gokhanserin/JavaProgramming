...
public class MapPractice4 {
    ...
    */
        ...
        System.out.println(groups.get(2).get(1));  // reaching the second student from group 2 which is an array list.
        System.out.println("--------------------------------------");

        for (ArrayList<String> eachGroup : groups.values()) { // printing all the names given in the "groups" map
